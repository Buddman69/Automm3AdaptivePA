...
#   Lowering the bed 300 mm (Max4; 340 mm is the physical max) creates
...
# 300 mm on the Max4: confirmed safe by Budd directly (340 mm is the physical
# max, so this leaves a 40 mm margin). NOT derived from config, and NOT
# ported to another model by changing this number alone - see CHANGELOG/.
BED_DOWN_Z = 300.0
# "Can be a bit faster... just to get it out of the way" - Budd's words. No
# stronger constraint than that was given, so this is a starting point, not a
# verified machine limit; override with BED_FEED= if it turns out wrong.
