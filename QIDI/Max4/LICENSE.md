...
# Notices for this software

Everything below this line is **not part of the licence above.** It identifies
the licensor and offers terms the licence itself does not grant.

## Required Notice

    Required Notice: Copyright (C) 2026 Budd

## Commercial use

The licence above permits noncommercial use only. **Commercial use requires a
separate paid licence** — an annual fee. Contact the copyright holder to arrange
one. Running a print farm, using this as part of a product or service, or any
other use in the course of a business is commercial use.

## Permission to modify your own copy

The licence above does not permit making changes to the software. That is
deliberate — it is what stops modified versions circulating.

It is **not** intended to stop you adapting your own copy to your own printer.
So, as an additional permission from the copyright holder, and only alongside a
valid licence above:

> You may modify your own copy of the software for your own permitted use on
> hardware you own. You may not distribute the modified copy, or any part of it,
> to anyone.

Without this, editing a constant for a different nozzle or a different load cell
would be a breach on day one, which is not the intent.
